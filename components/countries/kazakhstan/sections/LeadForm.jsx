        ...
        <Reveal>
          <div className="grid overflow-hidden rounded-[38px] bg-white shadow-[0_24px_70px_rgba(15,23,42,.08)] lg:grid-cols-[.9fr_1.1fr]">
            <div className="relative min-h-[360px] overflow-hidden lg:min-h-full">
              <img src="/images/kazakhstan/kazakhstan-counselling.webp" alt="Kazakhstan MBBS counselling" className="absolute inset-0 h-full w-full object-cover" />
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-8">
                ...
                <h2 className="mt-4 max-w-md text-3xl font-black leading-tight tracking-[-.035em] sm:text-4xl">Get the free Kazakhstan MBBS guide + cost estimate.</h2>
                <p className="mt-3 max-w-lg text-sm leading-6 text-white/75">Receive a Kazakhstan-specific planning guide and a personalised, no-obligation estimate based on your profile and budget.</p>
              </div>
            </div>
