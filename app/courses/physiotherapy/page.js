export async function generateMetadata() {
  return {
    title: "Physiotherapy Abroad - Coming Soon | Medico Yatra",
    description: "Physiotherapy abroad programs coming soon. Contact us for more information about studying physiotherapy internationally.",
    keywords: ["physiotherapy abroad", "study physiotherapy abroad", "bpt abroad", "physiotherapy career", "physiotherapy immigration"],
  };
}
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0263CC] to-[#0D47A1]">
      <div className="text-center text-white px-6">
        <h1 className="text-4xl lg:text-6xl font-bold mb-4">Physiotherapy Abroad</h1>
        <p className="text-xl lg:text-2xl mb-8 opacity-90">Coming Soon</p>
        <p className="text-lg mb-8 max-w-2xl mx-auto">
          We're working on creating comprehensive information about physiotherapy programs abroad. 
