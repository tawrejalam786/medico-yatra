      ...
      <div className="relative mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <p className="mt-6  text-[16px] w-full leading-7 text-slate-500 sm:text-[17px] sm:leading-8">
            Becoming a healthcare professional is one of the biggest
            decisions a family makes — and one of the most confusing.
          </p>
        </motion.div>
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          ...
          >
            ...
            <div className="absolute bottom-2 left-[7px] top-2 hidden w-px bg-gradient-to-b from-[#0263CC]/30 via-[#0263CC]/10 to-transparent sm:block" />

            <div className="space-y-9 sm:space-y-11">

              {/* Story block 01 */}
              <StoryBlock number="01">
                <p>
              ...
              {/* Story block 02 */}
              <StoryBlock number="02">
                <p>
                  Medico Yatra began with a simple belief:
                  <strong className="font-semibold text-[#09213d]">
                    {" "}
...
function StoryBlock({ number, children }) {
  return (
    <div className="relative sm:pl-10">

      {/* Number node */}
      <div className="absolute left-0 top-0 hidden sm:flex h-[15px] w-[15px] items-center justify-center rounded-full border-[3px] border-white bg-[#0263CC] shadow-[0_0_0_4px_rgba(2,99,204,0.08)]" />

      {/* Mobile number */}
      <div className="mb-3 flex items-center gap-3 sm:hidden">
        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#0263CC]/8 text-[10px] font-bold text-[#0263CC]">
          {number}
        </span>
      ...
      {/* Desktop number */}
      <div className="mb-3 hidden text-[10px] font-bold uppercase tracking-[0.2em] text-[#0263CC] sm:block">
        Chapter {number}
      </div>

      <div className="text-[15px] leading-7 text-slate-500 sm:text-[16px] sm:leading-8">
        {children}
      </div>
    </div>
  );
