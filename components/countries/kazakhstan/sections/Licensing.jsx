          ...
          <div className="relative overflow-hidden rounded-[34px] bg-[linear-gradient(135deg,#071A2D_0%,#0B2D4F_55%,#064B59_100%)] p-6 text-white sm:p-8 lg:p-10">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1.15fr_.85fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-5 max-w-3xl text-3xl font-black leading-[1.08] tracking-[-.04em] sm:text-4xl lg:text-[46px]">FMGE / NExT preparation should begin from Year 1 — not after graduation.</h2>
                <p className="mt-5 max-w-3xl text-sm leading-7 text-white/72 sm:text-base">Kazakhstan is not on India&apos;s FMGE-exempt list. Graduates intending to practise in India must clear the applicable licensing pathway. The supplied brief specifically notes that pass rates vary and early structured preparation can make a significant difference.</p>
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                <div className="rounded-[24px] border border-white/10 bg-white/8 p-5 backdrop-blur">
                  ...
                  <p className="mt-4 font-black">Start early</p>
                  <p className="mt-2 text-sm leading-6 text-white/65">Build consistency from the first year instead of relying on post-graduation cramming.</p>
                </div>
                <div className="rounded-[24px] border border-white/10 bg-white/8 p-5 backdrop-blur">
                  ...
                  <p className="mt-2 text-sm leading-6 text-white/65">NExT rollout and licensing requirements can change. Check current NMC notifications before applying.</p>
                </div>
              </div>
            </div>
          </div>
