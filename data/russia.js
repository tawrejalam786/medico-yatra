...
export const universities = [
  { name: "Kazan Federal University", city: "Kazan", note: "Established international programme", image: "/images/countries/russia/university-kazan.webp" },
  { name: "Volgograd State Medical University", city: "Volgograd", note: "Longstanding destination for Indian students", image: "/images/countries/russia/university-volgograd.webp" },
  { name: "Saint Petersburg State Pediatric Medical University", city: "Saint Petersburg", note: "One of Russia's older medical institutions", image: "/images/countries/russia/university-st-petersburg.webp" },
  { name: "Orenburg State Medical University", city: "Orenburg", note: "Popular among Indian students", image: "/images/countries/russia/university-orenburg.webp" },
  { name: "Kursk State Medical University", city: "Kursk", note: "Well-known among Indian MBBS students", image: "/images/countries/russia/university-kursk.webp" },
  { name: "Rostov State Medical University", city: "Rostov-on-Don", note: "Established programme in southern Russia", image: "/images/countries/russia/university-rostov.webp" },
];

export const studentLife = [
  { icon: Building2, title: "Hostel life", text: "University hostels are the standard option and are usually on or near campus.", image: "/images/countries/russia/life-hostel.webp" },
  { icon: Utensils, title: "Food", text: "Indian groceries and restaurants are available in major student cities; self-cooking is common.", image: "/images/countries/russia/life-food.webp" },
  { icon: CloudSnow, title: "Weather", text: "Russian winters are genuinely cold, so practical preparation matters.", image: "/images/countries/russia/life-winter.webp" },
  { icon: TrainFront, title: "Transport", text: "Major cities offer strong metro networks while smaller cities remain manageable by bus and taxi.", image: "/images/countries/russia/life-city.webp" },
];
