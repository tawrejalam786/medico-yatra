      ...
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[38px] border border-white bg-[linear-gradient(135deg,#EAF3FF_0%,#FFFFFF_45%,#E6FBF7_100%)] p-6 shadow-[0_22px_65px_rgba(15,23,42,.07)] sm:p-10 lg:p-12">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 max-w-3xl text-3xl font-black leading-tight tracking-[-.04em] text-slate-950 sm:text-4xl lg:text-5xl">Ready to explore Kazakhstan MBBS with a realistic plan?</h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">Kazakhstan offers one of the most financially accessible routes to an NMC-eligible medical degree. The winter and cultural adjustment are real — and so is the need for disciplined FMGE / NExT planning.</p>
          </div>
