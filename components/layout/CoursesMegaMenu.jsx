...
const COURSE_GROUPS = [
...

  {
    ...
    courses: [
      ...
      {
        name: "Anaesthesia OT Technology",
        slug: "anaesthesia-ot-technology",
        icon: Stethoscope,
      },
      {
        name: "Optometry Vision Science",
        slug: "optometry-vision-science",
        icon: ScanLine,
      },
      {
        name: "Medical Imaging Diagnostic Technology",
        slug: "medical-imaging-diagnostic-technology",
        icon: ScanLine,
      },
      {
        name: "Audiology Speech Language Pathology",
        slug: "audiology-speech-language-pathology",
        icon: Ear,
      },
    ],
  },
