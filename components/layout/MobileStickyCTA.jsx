...
export default function MobileStickyCTA() {
  ...
  return (
    ...
    >
      <div className="flex items-stretch bg-white border-t border-[#E2E8F0] shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        {/* Free Counselling */}
        <a
          href="/counselling"
        ...
        >
          ...
          <span className="font-body font-medium text-xs">Free Counselling</span>
        </a>
        ...
        >
          <WhatsAppIcon />
          <span className="font-body font-medium text-xs">WhatsApp</span>
        </a>
      </div>
    </div>
  );
